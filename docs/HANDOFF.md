...
src/systemapps/
  ...
  sticky/                           # w10sticky 便笺（E1）
  paint/                            # w10paint 画图（E2）
  pad/                              # w10pad 写字板（E3）
  charmap/                          # w10charmap 字符映射表（E4）
  clock/                            # w10clock 闹钟和时钟（E5）
  recorder/                         # w10recorder 录音机（E6，libpulse）
  cleanup/                          # w10cleanup 磁盘清理（E7）
  osk/                              # w10osk 屏幕键盘（E8，D-Bus 注入）
  rdp/                              # w10rdp 远程桌面（E9，FreeRDP 封装）
  disks/                            # w10disks 磁盘管理（E10，sysfs/udisks 只读）
  calendar/                         # w10calendar 日历（E11，月视图+事件）
